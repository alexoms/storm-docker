...
docker build -t="chang/base:2.3.0-storm" storm-2.3.0-cluster/os-base
...
docker build -t="zookeeper:2.3.0-storm" storm-2.3.0-cluster/zookeeper
...
docker build -t="chang/storm:2.3.0-storm" storm-2.3.0-cluster/storm
docker tag chang/storm:2.3.0-storm $ECR_REPO_BASE_URL/storm:2.3.0-storm
docker push $ECR_REPO_BASE_URL/storm:2.3.0-storm

docker build -t="storm-nimbus:2.3.0-storm" storm-2.3.0-cluster/storm-nimbus
...
docker build -t="storm-supervisor:2.3.0-storm" storm-2.3.0-cluster/storm-supervisor
...
docker build -t="storm-ui:2.3.0-storm" storm-2.3.0-cluster/storm-ui
