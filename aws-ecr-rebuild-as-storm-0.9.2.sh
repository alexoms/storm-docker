...
docker build -t="chang/base:0.9.2-storm" storm-0.9.2-cluster/os-base
...
docker build -t="zookeeper:0.9.2-storm" storm-0.9.2-cluster/zookeeper
...
docker build -t="chang/storm:0.9.2-storm" storm-0.9.2-cluster/storm
docker tag chang/storm:0.9.2-storm $ECR_REPO_BASE_URL/storm:0.9.2-storm
docker push $ECR_REPO_BASE_URL/storm:0.9.2-storm

docker build -t="storm-nimbus:0.9.2-storm" storm-0.9.2-cluster/storm-nimbus
...
docker build -t="storm-supervisor:0.9.2-storm" storm-0.9.2-cluster/storm-supervisor
...
docker build -t="storm-ui:0.9.2-storm" storm-0.9.2-cluster/storm-ui
